...
export default function ExamPageError({ error, reset }) {
  useEffect(() => {
    // Log the error to Sentry
    Sentry.captureException(error, {
      tags: { boundary: 'exam-page' }
    });
  }, [error]);
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-lg w-full text-center border border-red-100">
        ...
        <p className="text-gray-600 mb-8">
          The exam interface encountered an unexpected error. Don't worry, your progress is saved locally.
        </p>

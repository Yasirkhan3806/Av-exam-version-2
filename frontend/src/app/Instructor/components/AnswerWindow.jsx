        ...
        {showAnswer ? (
          ...
          <div className="flex items-center justify-center h-full bg-gray-50 rounded-lg">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-lg">Answer hidden for focused grading</p>
              <p className="text-gray-400 text-sm mt-2">Click "Show Answer" to view student's response</p>
            </div>
          </div>
        )}
      </div>

...
const StudentSubmissionsCard = ({ student }) => {
  ...
  const { currentSubjectType } = useInstructorStore((state) => state);
    ...
    >
      ...
      {currentSubjectType === "CAF" ? (
        <Link
          ...
          className="w-full flex items-center justify-center px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200"
        >
          Review CAF Answers
          <svg
            xmlns="http://www.w3.org/2000/svg"

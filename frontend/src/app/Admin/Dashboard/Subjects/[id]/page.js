...
import AddQuestionsPopup from "./components/CFAPForm";
...
const SubjectDetailsPage = () => {
  ...
  const handleAddExamPopUp = (subjectType) => {
    ...
    } else if (subjectType === "CFAP") {
      setIsCFAPPopupOpen(true);
    }
  };
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            The subject you are looking for doesnt exist.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Exams subjectId={id} subjectType={subject.type} />
        <br />
      ...
      />
      <AddQuestionsPopup
        isOpen={isCFAPPopupOpen}
        onClose={() => setIsCFAPPopupOpen(false)}
        subjectId={id}
      />
      <EnrollStudentPopup
      ...
      <EditSubjectForm
        ...
        subject={subject}
        onUpdate={(updatedSubject) => setSubject(updatedSubject)}
      />
    </div>
  );
};

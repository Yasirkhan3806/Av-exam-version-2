    ...
    <div className="flex items-center self-start mb-8 absolute
      top-4 left-4 justify-between">
        ...
        <div className="absolute top-4 right-4">
            <Link
            href="/elibrary"
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white font-medium rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105"
          >
            <svg
